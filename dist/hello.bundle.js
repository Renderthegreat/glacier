...
const bestTime = computed([hasJustWon], function (hasJustWon) {
...
const app = createApp(jsxs(Fragment, { children: [jsxs(Head, { children: [jsx(Meta, { name: "title", children: "Hello World!" }), usePico()] }), jsxs(Body, { children: [jsx(Header, { children: "My App" }), "Counter is ", counter, ". Time: ", elapsed.map((value) => (value / 1000).toFixed(3)), "s. Best time: ", bestTime.map((value) => (value / 1000).toFixed(3)), "s.", jsx(Break, {}), jsx(Button, { "on:click": () => {
                        counter.value++;
                    }, children: "Click here to increment the counter" }), jsx(Break, {}), jsx(Button, { "on:click": () => {
                        counter.value = 0;
                        startTime = window.performance.now();
                    }, children: "Click here to reset the counter" }), jsx(Break, {}), jsx(Show, { when: hasWon, children: "Good work!" })] })] }));
